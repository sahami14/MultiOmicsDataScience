...
gene.exp <- read.table("/home/samra/Dokumente/Studium/Bioinformatik/Module/Master/SoSe2023/Data Science Part1/Project/MultiOmic_Datascience-main/data/TCGA-BLCA.htseq_counts.tsv.gz",
...
write.table(gene.exp, file = "/home/samra/Dokumente/Studium/Bioinformatik/Module/Master/SoSe2023/Data Science Part1/Project/MultiOmic_Datascience-main/results/gene_exp_analysis/count_data.csv", sep = "\t", quote = FALSE, row.names = TRUE)
gene.exp <- as.data.frame(lapply(gene.exp, as.integer))
```

```{r reading clinical data}
clin.data <- read.csv("/home/samra/Dokumente/Studium/Bioinformatik/Module/Master/SoSe2023/Data Science Part1/Project/MultiOmic_Datascience-main/data/TCGA-BLCA.survival.tsv",
                      header = TRUE,sep = "\t",stringsAsFactors = FALSE)
...
phenotype <- read.csv("/home/samra/Dokumente/Studium/Bioinformatik/Module/Master/SoSe2023/Data Science Part1/Project/MultiOmic_Datascience-main/data/TCGA-BLCA.GDC_phenotype.tsv.gz",header=TRUE,sep="\t")
...
write.table(clin.data, file = "/home/samra/Dokumente/Studium/Bioinformatik/Module/Master/SoSe2023/Data Science Part1/Project/MultiOmic_Datascience-main/results/gene_exp_analysis/clinical.csv", sep = "\t", quote = FALSE, row.names = FALSE)
...
```{r biomart + cnv}
cnv_final <- read.csv("/home/samra/Dokumente/Studium/Bioinformatik/Module/Master/SoSe2023/Data Science Part1/Project/MultiOmic_Datascience-main/results/cnv_analysis/final_cnv.csv",stringsAsFactors=FALSE, header=TRUE)
