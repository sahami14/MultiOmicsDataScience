...
raw_count_stage2 <- as.data.frame(lapply(gene.exp[,colnames(gene.exp) %in% stage_2$sample], as.integer)) 
raw_count_stage3 <- as.data.frame(lapply(gene.exp[,colnames(gene.exp) %in% stage_3$sample], as.integer)) 
raw_count_stage4 <- as.data.frame(lapply(gene.exp[,colnames(gene.exp) %in% stage_4$sample], as.integer))
...
# Add clinical information to gene.data tables
